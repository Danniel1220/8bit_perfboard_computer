...
def export_best(config,candidate,report,directory):
    ...
    element('desc',parent=root,text='Editable perfboard candidate. Named nets and junction dots define connectivity. Read validation.json before construction. Underboard power and fixed ties are listed separately.')
